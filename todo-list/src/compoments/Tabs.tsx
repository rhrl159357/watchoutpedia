    ...
    return (
        <List>
            <ListItem onClick={() => onClick('about')}>
                <TabButton color={mapColorToHex(color?.name)} active={tab==='about'} >About</TabButton>
            </ListItem>
            <ListItem onClick={() => onClick('stats')}>
                <TabButton color={mapColorToHex(color?.name)} active={tab==='stats'} >Stats</TabButton>
            </ListItem>
            <ListItem  onClick={() => onClick('evolution')}>
            <   TabButton color={mapColorToHex(color?.name)} active={tab==='evolution'}>Evolution</TabButton>
            </ListItem>
        </List>
    )
}
